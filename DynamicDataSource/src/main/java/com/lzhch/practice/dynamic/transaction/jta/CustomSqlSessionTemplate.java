...
/**
 * 自定义 SqlSessionTemplate, 实现 SqlSessionFactory 的切换
 * <p>
 * author: lzhch
 * version: v1.0
 * date: 2024/1/4 18:07
...
public class CustomSqlSessionTemplate extends SqlSessionTemplate {
    ...
    public SqlSessionFactory getSqlSessionFactory() {
        SqlSessionFactory targetSqlSessionFactory = targetSqlSessionFactoryMap.get(DynamicDataSourceContextHolder.peek());
        if (targetSqlSessionFactory != null) {
            return targetSqlSessionFactory;
        } else if (defaultTargetSqlSessionFactory != null) {
            return defaultTargetSqlSessionFactory;
        } else {
            Assert.notNull(targetSqlSessionFactoryMap, "Property 'targetSqlSessionFactoryMap' or 'defaultTargetSqlSessionFactory' are required");
            Assert.notNull(defaultTargetSqlSessionFactory, "Property 'defaultTargetSqlSessionFactory' or 'targetSqlSessionFactoryMap' are required");
        }
